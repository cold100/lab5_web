...
app.config['RECAPTCHA_PUBLIC_KEY'] = '6LcCVSQbAAAAAEpFBGQiWiNebUDmKpyvvaqnnYnB'
app.config['RECAPTCHA_PRIVATE_KEY'] = '6LcCVSQbAAAAALf9RCiSS0hJAEOvCoUbYybTN-t4'
...
def apinet():
  neurodic = {}
  # проверяем что в запросе json данны
